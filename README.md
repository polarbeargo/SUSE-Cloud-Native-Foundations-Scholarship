...
Day 18 - Sprint 2:  
Yesterday: Revisited Lesson 3 Container Orchestration with Kubernetes section 17 Kubernetes Resources Part 2. Read, and implemented [Data Engineer Nanodegree Program](https://www.udacity.com/course/data-engineer-nanodegree--nd027) project data lake. Participated in the AMA Sessions with SUSE received a lot of guidance from @Tim and @Luke 🌟! Joined the SUSE and Rancher community discovered many Academy classes and open source projects 😆. Warm catch up with my study buddy @German.Ramirez had, having a good time share thoughts together.  
